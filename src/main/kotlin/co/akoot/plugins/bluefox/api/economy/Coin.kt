...
open class Coin(
    ...
    companion object {
        ...
        private val DEFAULT_DIA =
            Coin(1, "DIA", "Diamond", "Diamond Coin", Material.DIAMOND.itemStack, Material.DIAMOND_BLOCK.itemStack)
        private val DEFAULT_NTRI = Coin(
            2,
            "NTRI",
            "Netherite",
            "Netherite Coin",
            Material.NETHERITE_INGOT.itemStack,
            Material.NETHERITE_BLOCK.itemStack
        )
        private val DEFAULT_AD =
            Coin(3, "AD", "Ancient Debris", "Ancient Debris Coin", Material.ANCIENT_DEBRIS.itemStack)
        private val DEFAULT_AMETHYST = Coin(
            4, "AMETHYST", "Amethyst", "Amethyst Coin", Material.AMETHYST_SHARD.itemStack.withDisplayName(
